...
export async function generateMetadata() {
  return {
    title: "Контакти - Адвокатско дружество „Бурков, Радев и партньори“",
    description:
      "Свържете се с Адвокатско дружество „Бурков, Радев и партньори“ за правна консултация. Нашият екип е на разположение да отговори на вашите въпроси и да предложи експертни решения. Намерете нашите контакти и адрес тук.",
  };
}
